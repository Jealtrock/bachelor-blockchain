...
\caption[Graph Angriffswahrscheinlichkeit]{Je weiter der Angreifer zurückliegt desto unwahrscheinlicher ein erfolgreicher Angriff (Quelle https://www.btc-echo.de/tutorial/bitcoin-51-attacke/)}%
\label{fig:26prozent}%
\end{figure}
...
\caption[Graph Blockgenerierung]{Wahrscheinlichkeit sechs Blöcke hintereinander zu generieren (Quelle https://www.btc-echo.de/tutorial/bitcoin-51-attacke/)}%
\label{fig:51prozent}%
\end{figure}
...
Diese Attacke wird jedoch verhindert, solange die Parasiten-Kette nicht mehr Rechenleistung besitzt als die Hauptkette. Der Tip-Auswahlmechanismus (Markov Chain Monte Carlo) verhindert, dass Tips ausgewählt werden, die sich von der Gewichtung stark von der Norm unterscheiden.~\cite{je:theTangle}
