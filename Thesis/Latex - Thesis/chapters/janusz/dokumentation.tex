...
\begin{itemize}
	\item Der Nutzer muss vor dem dem Tankvorgang über die Tankstelle informiert werden
	\item Der Nutzer soll mit einem Knopfdruck tanken können
	\item Der Nutzer soll mit einem Knopfdruck bezahlen können, ohne das weitere Eingaben notwendig sind
...
MFJGFXAWEB9GNTQWEDVRYHKIOQF9T9IZY9IVPKTSZK"' wurde aus einer zufälligen Kombination der Großbuchstaben 'A-Z' und der Nummer 9 eigenhändig generiert und wird für den Prototypen genutzt. Im Programmcode ist der Seed hinterlegt, dies könnte bei einer realistischen Umgebung zu Sicherheitsrisiken führen, für die prototypische Umsetzung genügt es.
