...
Um mit NodeJS effektiv arbeiten zu können benötigen alle Programmierer eine geeignete Bash (Shell). Viele Unix und Linux Distributionen besitzen eine geeignete vorinstallierte Bash die für die meisten Befehle ausreicht. Um mit Windows entsprechend zu arbeiten, empfiehlt sich die Installation von der PowerShell\footnote{https://docs.microsoft.com/de-de/powershell/scripting/powershell-scripting?view=powershell-6}.
