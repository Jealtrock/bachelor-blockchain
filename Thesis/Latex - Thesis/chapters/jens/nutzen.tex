\chapter{Nutzen}
Das Kapitel Nutzen umfasst einen Überblick über implementierte Möglichkeiten in den Kryptowährungen IOTA und Bitcoin. Dabei werden Funktionen wie MAM (Masked Authenticated Messages) als Funktion von IOTA näher erörtert. Auch das Potenzial der Blockchain hinsichtlich "`Smarts Contracts"' wird erläutert.
